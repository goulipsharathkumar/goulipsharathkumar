...
- 🛠️ **Stack:** React.js · Node.js · MongoDB · Context API · JWT · Axios · CSS3
- ✅ JWT login, protected routes, Context API cart, 6+ reusable components, fully responsive

---

### 🎬 Movie Database Application
> React SPA integrated with TMDB third-party REST API

- 🔗 **Live Demo:** https://frabjous-chebakia-4f6502.netlify.app
- 📌 **GitHub:** https://github.com/goulipsharathkumar/movie-db-app
- 🛠️ **Stack:** React.js · React Router DOM · Axios · TailwindCSS · TMDB API · JavaScript ES6+
- ✅ Real-time movie data, search, pagination, cast & details, error handling, fully responsive

---

### 🛍️ NxtTrendz – E-Commerce Web App
> Full-featured E-Commerce SPA with product listing, filters, and cart

- 🔗 **Live Demo:** https://nxt-trend-web.vercel.app
- 📌 **GitHub:** https://github.com/goulipsharathkumar/NxtTrend-web
- 🛠️ **Stack:** React.js · Node.js · MongoDB · Context API · JWT · Bootstrap · REST APIs
- ✅ Keyword search, multi-filter, JWT auth, cookie session, real-time cart total

---

### 💼 Jobby App – Job Search Platform
> React SPA for searching and filtering jobs with authentication

- 🔗 **Live Demo:** https://jobby-app-zu3n.vercel.app
- 📌 **GitHub:** https://github.com/goulipsharathkumar/jobby-app
- 🛠️ **Stack:** React.js · React Router DOM · Axios · JWT · JavaScript ES6+ · CSS3
- ✅ 3 filter types, protected routing, loading/error/retry states, sticky header
...
## 🏆 Certifications — NxtWave CCBP Academy

- ✅ [React.js](https://certificates.ccbp.in/intensive/react-js)
- ✅ [Node.js](https://certificates.ccbp.in/intensive/node-js)
- ✅ [JavaScript Essentials](https://certificates.ccbp.in/intensive/javascript-essentials)
...
![Sharath's GitHub Stats](https://github-readme-stats.vercel.app/api?username=goulipsharathkumar&show_icons=true&theme=tokyonight&hide_border=true)
![Top Languages](https://github-readme-stats.vercel.app/api/top-langs/?username=goulipsharathkumar&layout=compact&theme=tokyonight&hide_border=true)
...
> ⭐ **Open to Junior Full Stack / MERN Developer roles in Bengaluru — Immediate Joiner!**
